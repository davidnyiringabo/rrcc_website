    ...
    <main className="w-full px-4 md:px-14 mb-10">
      ...
      <div className='w-full md:px-2'>
        ...
        <div className='w-full flex flex-col md:grid grid-cols-3 gap-x-4 justify-center mt-5'>
          ...
          <NewsComponent image={img2} header='RCA Red Cross visited Genocide Memorial Site' content='The Red Cross also plays a significant role in promoting healthcare and preventing diseases through various initiatives, including vaccination campaigns, health education, and access to clean water and sanitation facilities.' date='12/11/2022'/>
          <NewsComponent image={img3} header='RCA Red Cross visited Genocide Memorial Site' content='The Red Cross also plays a significant role in promoting healthcare and preventing diseases through various initiatives, including vaccination campaigns, health education, and access to clean water and sanitation facilities.' date='12/11/2022'/>
          <NewsComponent image={img4} header='RCA Red Cross visited Genocide Memorial Site' content='The Red Cross also plays a significant role in promoting healthcare and preventing diseases through various initiatives, including vaccination campaigns, health education, and access to clean water and sanitation facilities.' date='12/11/2022'/>
          <NewsComponent image={img5} header='RCA Red Cross visited Genocide Memorial Site' content='The Red Cross also plays a significant role in promoting healthcare and preventing diseases through various initiatives, including vaccination campaigns, health education, and access to clean water and sanitation facilities.' date='12/11/2022'/>
          <NewsComponent image={img6} header='RCA Red Cross visited Genocide Memorial Site' content='The Red Cross also plays a significant role in promoting healthcare and preventing diseases through various initiatives, including vaccination campaigns, health education, and access to clean water and sanitation facilities.' date='12/11/2022'/>
        </div>
      </div>
      <div className="w-[100%] py-5 flex flex-col md:flex-row items-center md:items-start justify-between py-10 mt-12">
            <div className="w-full md:w-[50%]">
                ...
                <button className="bg-[#CC0000] text-[80%] text-white rounded-lg py-3 px-7 md:my-10">Join Us</button>
            </div>

            <Image src={flag} alt="" className="mt-4 w-[80%] md:w-[40%] h-[23rem] md:mt-0 rounded-lg md:mt-[-3rem]"/>
        </div>
    </main>
  )
}
