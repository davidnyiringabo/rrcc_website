  ...
  return (
    <html lang="en">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@700&family=Montserrat:wght@400&family=Nunito:wght@600&display=swap" rel="stylesheet"/>
