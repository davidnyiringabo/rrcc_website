    ...
    <div className="w-full flex md:flex-row flex-col justify-between px-4 md:px-14 pb-[8rem]">
      <div className="w-full md:w-[30%] flex flex-col items-center md:items-start justify-center">
        ...
        <div className="w-full flex flex-col justify-center md:justify-start gap-4">
            ...
            <span className="flex items-center gap-2">
                <Club/>
                <h6 className="text-[90%] font-semibold">Club time: Saturday 14:30-15:30</h6>
            </span>
        </div>
      </div>
      ...
      <div className="w-full md:w-[55%] flex flex-col justify-center gap-4">
            ...
            <h6 className="text-[90%] text-justify">Get in touch with the Red Cross team. Your concerns and ideas are highly appreciated. We will reach out to you in no time!</h6>
            <form onSubmit={submit} className="md:w-full flex flex-col items-center gap-4">
