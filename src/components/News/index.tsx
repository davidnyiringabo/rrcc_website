...
const NewsComponent = ({
  ...
  return (
    <div
      className="w-[90%] rounded-lg flex flex-col gap-2 shadow-lg shadow-slate-400 my-3 pb-2 cursor-pointer"
      style={{ boxShadow: "3px 3px 23px 0px #0000003D" }}
    >
      ...
      <Link
        href={"/"}
        className="text-[#CC0000] font-bold text-[60%] px-2 mt-[-8px]"
      >
        Read more
      </Link>
