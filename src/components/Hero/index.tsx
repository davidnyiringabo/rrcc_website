    ...
    return(
        <div className="w-[100%] py-5 flex flex-col md:flex-row items-center md:items-start justify-between py-10 pt-10">
            <div className="w-full md:w-[50%]">
                ...
                <p className="mb-2 my-3 mb-6 text-[80%] font-light text-[#1E1E1E]">The Red Cross is an international humanitarian organization that provides assistance and support to those in need, particularly during times of crisis and emergencies.</p>
