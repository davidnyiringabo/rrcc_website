    ...
    return(
        <div className="w-full flex flex-col md:flex-row gap-3 md:gap-0 items-start justify-start md:items-center bg-[#212121] justify-between px-14 text-white py-[10vh] pb-[15vh] md:py-0 md:pb-0 md:h-[60vh]">
            <div className="w-full md:w-[45%] flex items-start flex-col h-[80%]">
                ...
                <h5 className="text-[80%] font-medium mb-5">The club's mission is aligned with the broader mission of the Red Cross, which is to alleviate human suffering and protect human dignity.</h5>
            ...
            <div className="flex flex-col gap-2 items-start h-[80%]">
                ...
                <Link className="text-[90%] flex items-center ml-4 my-[0.2rem] font-extralight" href={"/"}> <span><FiChevronRight size={13}/></span> <span className="text-[85%] font-extralight underline">Home</span></Link>
                <Link className="text-[90%] flex items-center ml-4 my-[0.2rem] font-extralight" href={"/activities"}> <span><FiChevronRight size={13}/></span> <span className="text-[85%] font-extralight underline">Activities</span></Link>
                <Link className="text-[90%] flex items-center ml-4 my-[0.2rem] font-extralight" href={"/resources"}> <span><FiChevronRight size={13}/></span> <span className="text-[85%] font-extralight underline">Resources</span></Link>
                <Link className="text-[90%] flex items-center ml-4 my-[0.2rem] font-extralight" href={"/about"}> <span><FiChevronRight size={13}/></span> <span className="text-[85%] font-extralight underline">About Us</span></Link>
                <Link className="text-[90%] flex items-center ml-4 my-[0.2rem] font-extralight" href={"/contact"}> <span><FiChevronRight size={13}/></span> <span className="text-[85%] font-extralight underline">Contact Us</span></Link>
            </div>
            <div className="flex flex-col gap-2 items-start justify-start h-[80%]">
                ...
                <h6 className="text-[85%] flex gap-2 items-center justify-start w-full pl-3">
                    <MdOutlineEmail color="#FFF"/> rcaredcross@gmail.com</h6>
                <h6 className="text-[85%] flex gap-2 items-center justify-start w-full pl-2">
                    <MdLocationPin size={18} color="#FFF"/> Nyabihu,Mukamira</h6>
                <h6 className="text-[85%] flex gap-2 items-center justify-start w-full pl-3">
                    <FaPhone color="#FFF"/> 07843472824</h6>
            </div>
        </div>
    )
}
