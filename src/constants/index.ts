...
export const goals = [
    {
        ...
        content:" The club aims to educate members and the community on the importance of disaster preparedness, including emergency planning, first aid training, and response protocols."
    },
    {
        icon: img,
    ...
    },
    {
        ...
        content:"The club promotes health and safety education by organizing workshops, training sessions, and awareness campaigns on topics such as CPR and first aid, disease prevention, mental health support, and healthy living."
    },
    {
        icon: img,
        head:"Blood Drives and Donor Recruitment",
        content:"The club actively participates in organizing and promoting blood drives, encouraging individuals to donate blood to ensure a safe and sufficient blood supply."
    },
    {
        icon: img,
        head:"International Humanitarian Values",
        content:"The club upholds and promotes the fundamental Red Cross values of humanity, impartiality, neutrality, independence, voluntary service, unity, and universality."
    }
]